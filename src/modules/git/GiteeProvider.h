#ifndef GITEE_PROVIDER_H
#define GITEE_PROVIDER_H
...
// Gitee API endpoints
#define GITEE_API_BASE "https://gitee.com/api/v5"
#define GITEE_TOKEN_HEADER "Authorization: token "
#define GITEE_USER_AGENT "Bruce-ESP32/1.0"

class GiteeProvider : public GitProvider {
public:
    GiteeProvider();
    ~GiteeProvider();
    ...
    void end() override;
    String getProviderName() override { return "Gitee"; }
...
private:
    ...
    // URL encoding helper
    String extractGiteeJsonValue(const String& json, const String& key);
};

#endif // GITEE_PROVIDER_H